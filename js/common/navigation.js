const Navigation = {
    injectNavigation(role) {
        ...
        const icons = {
            ...
            bible: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"></path><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"></path></svg>`,
            memorization: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path></svg>`
        ...
        const sidebarItems = role === 'pastor' ? [
            ...
            { id: 'memorization', label: '암송', icon: icons.memorization },
            { id: 'bible', label: '성경', icon: icons.bible },
            { id: 'schedule', label: '일정', icon: icons.calendar }
        ];
